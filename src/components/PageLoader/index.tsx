...
const PageLoader = () => (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-white z-[9999]">
        <div className="relative flex items-center justify-center">
            ...
            {/* Center Logo */}
            <div className="absolute w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center text-zinc-900 dark:text-white font-bold shadow-lg shadow-indigo-100">
                B
            </div>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center gap-1.5">
            ...
            <div className="flex items-center gap-1">
                <span className="text-sm text-zinc-600 dark:text-zinc-400 font-medium">Loading...</span>
