...
const Footer: React.FC = () => {
    ...
    return (
        <>
            <footer className="relative py-12 border-t border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-zinc-950 overflow-hidden mb-[72px] sm:mb-0">
                {/* Background Effects */}
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-6 mb-10">
                            <a href="/#features" className="px-4 py-2 rounded-full bg-zinc-100 dark:bg-white/5 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-white/10 text-sm font-medium transition-all">
                                Özellikler
                            </a>
                            <button onClick={() => setIsLegalModalOpen(true)} className="px-4 py-2 rounded-full bg-zinc-100 dark:bg-white/5 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-white/10 text-sm font-medium transition-all">
                                Yasal Uyarı
                            </button>
                            <a href="mailto:fatalsoft.inc@gmail.com" className="px-4 py-2 rounded-full bg-zinc-100 dark:bg-white/5 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-white/10 text-sm font-medium transition-all">
                                İletişim
                            </a>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 mb-12 w-full max-w-md justify-center">
                            ...
                            <a
                                ...
                                className="w-full sm:w-auto flex-1 flex items-center gap-3 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-white/10 hover:border-amber-500/50 rounded-xl px-4 py-3 transition-all group"
                            >
